    ...
    function ajaxCalls(type)
    {
        switch(type)
        {
            ...
            case "List":
                ...
                $.ajax({ url: "Home/listCourse", type: "GET", data: { returnType: bgType, columnName: selectedOption }, success: function (data) { displayData(data); } });
                break;
            case "Search":      
                var selectedOption = $('#searchElements').find(":selected").val();
                console.log(selectedOption);
                $.ajax({ url: "Home/searchCourse", type: "GET", data: { returnType: bgType, columnName: selectedOption, searchTerm: $("#searchBox").val() }, success: function (data) { displayData(data); } });
                break;
        }
    }
